import { b as createLucideIcon, r as reactExports, j as jsxRuntimeExports, c as cn, R as React2, i as reactDomExports, a as useLanguage, f as ue } from "./index-Cr1cOiS1.js";
import { G as GlowButton } from "./GlowButton-BIc89jFq.js";
import { B as Badge } from "./badge-B2y5IC2E.js";
import { P as Primitive } from "./index-QJrUuAdR.js";
import { b as Primitive$1, P as Presence, e as createContextScope$1, c as composeEventHandlers, j as useCallbackRef, k as useLayoutEffect2, g as createSlot, u as useControllableState, a as useId, d as Portal$2, h as hideOthers, f as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, l as createSlottable } from "./index-JsIvX_i-.js";
import { u as useComposedRefs } from "./index-BO87SLi9.js";
import { C as ChevronDown } from "./chevron-down-0TP7A0Vo.js";
import { C as Check } from "./check-N9hZJcIw.js";
...
function WinnerCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      "data-ocid": `winners.item.${index2 + 1}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-transparent via-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-smooth pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-3 right-3 text-[10px] font-body font-bold px-2 py-0.5 rounded-full bg-primary/20 text-primary border border-primary/40 tracking-wider", children: "¡GANADOR!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: countryFlag(winner.countryCode)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body font-semibold text-foreground truncate", children: [
            winner.name,
            " · ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-xl font-bold text-primary leading-none", children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-body font-normal", children: winner.currency })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "mt-1 text-sm text-foreground/80 italic border-l-2 border-primary/40 pl-3 leading-snug line-clamp-2", children: [
            '"',
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              "data-ocid": `winners.congratulate_button.${index2 + 1}`,
              variant: congratulated ? "ghost" : "outline",
              size: "sm",
              onClick: () => onCongratulate(winner.id),
              disabled: congratulated,
              className: "text-xs",
              children: congratulated ? "✓ ¡Felicitado!" : "🎉 Felicitar / Congratulate"
            }
          ) })
        ] })
      ]
...
function BadgeCard({ badge, index: index2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      "data-ocid": `badges.item.${index2 + 1}`,
      initial: { opacity: 0, scale: 0.9 },
      whileInView: { opacity: 1, scale: 1 },
      viewport: { once: true },
      transition: { delay: index2 * 0.07, duration: 0.35 },
      className: cn(
        "flex flex-col items-center gap-2 p-4 rounded-2xl border text-center transition-smooth",
        badge.locked ? "bg-muted/40 border-border opacity-60 grayscale" : "bg-card border-primary/40 glow-gold"
      ),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: cn(
              ...
              badge.locked ? "border-border bg-muted" : "border-primary/60 bg-primary/10"
            ),
            children: badge.locked ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", "aria-hidden": "true", children: "🔒" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-label": badge.nameEs, children: badge.emoji })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: badge.nameEs
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body leading-snug", children: badge.locked ? /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              "data-ocid": `badges.tooltip.${index2 + 1}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TooltipContent,
            {
              ...
              children: badge.howToEarnEs
            }
          )
        ] }) }) : badge.descriptionEs }),
        !badge.locked && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
            variant: "outline",
...
function CommunityPage() {
  ...
  const { t } = useLanguage();
  const [congratulated, setCongratulated] = reactExports.useState(/* @__PURE__ */ new Set());
  const [selectedCause, setSelectedCause] = reactExports.useState("education");
  const [donateToggle, setDonateToggle] = reactExports.useState(false);
  const [activeTab, setActiveTab] = reactExports.useState(
    "winners"
  );
  function handleCongratulate(id) {
    setCongratulated((prev) => {
      const next = new Set(prev);
      next.add(id);
      return next;
    });
    ue.success("¡Enviaste felicitaciones! 🎉", {
      description: "Tu mensaje llegará al ganador.",
      duration: 4e3
    });
  }
  function handleDonateToggle(checked) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", "data-ocid": "community.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b border-border px-4 pt-8 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h1,
        {
          ...
          children: [
            "Comunidad",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-normal text-xl", children: "/ Community" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          children: '"La suerte compartida es doble suerte"'
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-sm font-body text-primary font-medium", children: [
              "🏆 ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "4,891 ganadores este mes" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-secondary/10 border border-secondary/30 text-sm font-body text-secondary font-medium", children: [
              "🌎 ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "23 países" })
            ] })
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-lg mx-auto px-4 pt-6 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Tabs,
      {
        value: activeTab,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "winners", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ScrollArea,
            {
              className: "h-[calc(100vh-320px)] min-h-[400px]",
              "data-ocid": "winners.list",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4 pr-1", children: winners.map((winner, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                WinnerCard,
                {
                  winner,
                  index: i,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "badges", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0 },
              animate: { opacity: 1 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-xl font-semibold text-foreground", children: [
                    "Mis logros",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-normal text-base", children: "/ My achievements" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body mt-0.5", children: "Colecciona insignias completando retos" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", "data-ocid": "badges.grid", children: ALL_BADGES.map((badge, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeCard, { badge, index: i }, badge.id)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 bg-muted/30 border border-border rounded-2xl p-4 flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", "aria-hidden": "true", children: "🎯" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-semibold text-foreground", children: "2 de 5 insignias desbloqueadas" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Sigue jugando para ganar más logros" })
                  ] })
                ] })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "purpose", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 12 },
              animate: { opacity: 1, y: 0 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold text-foreground", children: "Tu suerte también ayuda" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body mt-0.5", children: "Your luck also helps" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-4", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body font-semibold text-foreground leading-snug", children: "Educación en Latinoamérica" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Education in Latin America" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Badge,
                          {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body text-muted-foreground", children: "$320,450 recaudado" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-semibold text-secondary", children: "67%" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Progress,
                          {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body mt-1.5", children: "Meta: $480,000 USD" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 bg-secondary/10 border border-secondary/20 rounded-xl px-4 py-2.5 flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", "aria-hidden": "true", children: "💚" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-secondary font-medium", children: "$45 USD donados en tu nombre este mes" })
                      ] })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "label",
                    {
                      ...
                      children: "Elegir causa / Choose cause"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Select,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "rounded-xl font-body", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "education", children: "📚 Educación / Education" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "environment", children: "🌿 Medio Ambiente / Environment" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "healthcare", children: "🏥 Salud / Healthcare" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "children", children: "👶 Niñez / Children" })
                        ] })
                      ]
                    }
                  )
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-semibold text-foreground leading-snug", children: "Donar 1% de mi próximo premio" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body mt-0.5", children: "Donate 1% of my next prize" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Switch,
                        {
                  ...
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-body text-foreground", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary", children: "12,403 participantes" }),
                        " ",
                        "han donado este mes"
                      ] })
                    ]
