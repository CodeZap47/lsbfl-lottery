import { d as useParams, u as useNavigate, a as useLanguage, r as reactExports, j as jsxRuntimeExports, c as cn, T as Ticket, f as ue } from "./index-Cr1cOiS1.js";
import { C as Confetti } from "./Confetti-lmBtJfMn.js";
import { C as CountdownTimer } from "./CountdownTimer-UWjXTuhT.js";
...
import { S as Shield } from "./shield-D1iPZsZK.js";
const STAR_COUNT = 60;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        boxShadow: "0 0 20px oklch(0.72 0.18 80 / 0.5), 0 4px 12px oklch(0 0 0 / 0.4), inset 0 1px 0 oklch(1 0 0 / 0.3)",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: "radial-gradient(ellipse at 30% 30%, oklch(0.16 0.03 80 / 0.8), oklch(0.08 0.01 50) 70%)",
          boxShadow: "0 0 40px oklch(0.72 0.18 80 / 0.3), 0 0 80px oklch(0.72 0.18 80 / 0.15), inset 0 0 30px oklch(0 0 0 / 0.5)"
        },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.72 0.18 80 / 0.3), transparent 70%)"
              },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: "radial-gradient(ellipse at 50% 0%, oklch(0.14 0.04 80 / 0.5) 0%, oklch(0.07 0.01 50) 60%)"
        },
        "data-ocid": "draw.page",
        children: [
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: userTickets.map((ticket, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              style: {
                                background: ticket.status === "Winner" ? "radial-gradient(ellipse at 0% 50%, oklch(0.15 0.05 80 / 0.6), oklch(0.10 0.01 50 / 0.8))" : "oklch(0.10 0.01 50 / 0.7)",
                                boxShadow: ticket.status === "Winner" ? "0 0 20px oklch(0.72 0.18 80 / 0.2)" : void 0
                              },
